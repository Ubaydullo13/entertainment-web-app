    ...
    <div className="rootPage">
      <header className="rootPage__header">
        ...
        <div className="rootPage__header--menu">
          <NavLink className="rootPage__header--menu--item" to="/search">
          ...
          <NavLink className="rootPage__header--menu--item" to="/">
          ...
          <NavLink className="rootPage__header--menu--item" to="/movie">
            <svg width="20" height="20" xmlns="http://www.w3.org/2000/svg">
              <path
          ...
          <NavLink className="rootPage__header--menu--item" to="/tv">
            <svg width="20" height="20" xmlns="http://www.w3.org/2000/svg">
              <path
          ...
          <NavLink className="rootPage__header--menu--item" to="/bookmark">
